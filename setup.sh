...
docker run --network apt-network -v "$PWD"/assets:/assets --rm mongo:latest mongoimport --host my-mongo --db='subscriptions' --collection='orders' --headerline --file=assets/sample-orders.csv --type=csv
